...
const Productcategory = (c_ourservice: product) => {
  let length = c_ourservice.prop.length;
      ...
      >
        <div className=" bg-light">
          <div className="container mx-auto">
            ...
            >
              {c_ourservice.prop &&
                c_ourservice.prop.map((i: any, index: any) => {
                  return (
                    ...
                    <SplideSlide key={index}>
                      {i.title ? (
                        <div className="slide-img">
                          ...
                          <img
                        src={i.image ? i.image.url : "https://www.vodafone.co.uk/cs/groups/public/documents/images/vfcon117898.jpg"}
                        className="block"
                        alt={i.description}                      
                      />
                          ...
                          {/* <img
                                  ...
                                  alt={i.text}
                                /> */}
                            <h2 className="font-bold text-black">{i.title}</h2>
                          </div>
                        </div>
                      ) : ""}
