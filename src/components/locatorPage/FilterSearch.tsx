...
import { AnswerExperienceConfig, googleApikey } from "../../config/globalConfig";
...
const builtInCssClasses: FilterSearchCssClasses = {
  ...
  dropdownContainer:
    "relative z-10 shadow-lg w-full rounded-md border border-gray-300 bg-white pt-3 pb-1 px-4 mt-1",
  inputElement:
    "text-sm bg-white outline-none h-9 w-full p-2 rounded-md border border-black-300 focus:border-blue-600",
  sectionContainer: "pb-10",
  sectionLabel: "text-sm text-gray-700 font-semibold pb-2",
  focusedOption: "bg-gray-100",
  option: "text-sm text-black-700 pb-1 cursor-pointer",
};
