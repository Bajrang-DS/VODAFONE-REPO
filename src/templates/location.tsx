...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps> = ({
  ...
  return {
    ...
    tags: [
      ...
      //   attributes: {
      //     rel: "canonical",
      //     href:`${document._site.c_metaTags.canonicalURL ? document._site.c_metaTags.canonicalURL + `${document.id}-${result}.html`: stagingBaseUrl + `${document.id}-${result}.html`}`
      //   },
      // },
      // // // og tags
      ...
      //   attributes: {
      //     property: "og:url",
      //     content: `${document._site.c_metaTags.canonicalURL ? document._site.c_metaTags.canonicalURL + `${document.id}-${result}.html`: stagingBaseUrl + `${document.id}-${result}.html`}`,
      //   },
      // },
