...
export const svgIcons = {
    ...
    findouticon: (
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="search" className="w-4" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path fill="blue" d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z"></path>
        </svg>
    ),
    locatorphoneicon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="17.334" height="18.499" viewBox="0 0 17.334 18.499">
            <g transform="translate(-81 -628)">
                ...
                <path d="M87.25,633.266c.469,1.266-1.62,1.552-1.62,2.583s3.644,5.58,5.045,5.7-.833,2.945-3.758.792-5.569-8.332-5.011-9.577,1.656-2.906,2.594-2.562A6.009,6.009,0,0,1,87.25,633.266Z" fill="blue" />
            </g>
        </svg>
